...
variable "mongodb_security_group_name" {
  type        = string
  description = "The name security group of MongoDB."
  default     = ""
}

variable "mongodb_security_group_description" {
  type        = string
  description = "The description for security group of MongoDB"
  default     = ""
}
